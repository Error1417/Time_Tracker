...
//                usrArr[3]->printAdUsr();                                            
            ...
            case 4:  // Edit time in binary and text files
            {    
                int n = 0;  
                Admin admin4;
...
void Admin::getAllUsrs(Admin **usrArr){
    ...
    while(i < nRec){
        ...
        // Read in size of time and add to cursor
        inBin.read(reinterpret_cast<char *>(&num) , sizeof(int)); 
...
void Admin::setUsrTime(){ 
    ...
    do {
        cout<<"\nEdit " << user.getName() << "'s time.\nEnter a number of hours or minutes to add.: " << endl;
                
        cout << "Enter h or hours and m for minutes." << endl;
        cin >> choice;
        
        while(choice != 'h' &&choice != 'H' &&choice != 'm' &&choice != 'M'){
            cout << "Wrong input. Try again! H or M" <<endl;
            cin >> choice;
        }
        ...
        switch(choice){
            case 'h':
            case 'H':
                cout << "Enter the number of number of hours to add. Positive numbers" << endl;
                cin >> hScore;
            ...
            case'm':
            case 'M':
                cout << "Enter the number of number of minutes to add. Positive numbers" << endl;
                cin >> score;
